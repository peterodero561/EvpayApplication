...
def test_register_user(client):
    ...
    # Normal url
    response = client.post('/api/auth/register_user', data={
        'name': 'testUser',
...
def test_register_driver(client):
    ...
    response = client.post('/api/auth/register_driver', data={
        'name': 'testDriver',
...
def test_register_garage_manager(client):
    ...
    response = client.post('/api/auth/register_manager', data={
        'name': 'testManager',
...
def test_register_bus(client):
    ...
    response = client.post('/api/auth/register_bus', data={})
...
def test_register_garage(client):
    ...
    # normal url b4 login
    response = client.post('/api/auth/register_garage', data={
